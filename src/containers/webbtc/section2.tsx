...
export default function Section2() {
  const cardInfo = {
    ...
    text: "Integrating WebBTC in your web application is straightforward. Set up support for this new standard today and join the era of Bitcoin interoperability!",
    cards: [
      {
